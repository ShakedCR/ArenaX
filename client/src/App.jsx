...
import { GOLD, DARK } from './styles/themeConstants.js'
...
const Trivia            = lazy(() => import('./pages/Game/Trivia'))
          ...
          <BrowserRouter>
            <Suspense fallback={<PageLoader />}>
              <Routes>
                ...
                <Route path="/game/trivia/:id" element={<ProtectedRoute><Trivia /></ProtectedRoute>} />
              </Routes>
            </Suspense>
          </BrowserRouter>
        </Box>
